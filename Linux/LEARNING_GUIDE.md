...
9. [systemd 服务沙箱与凭据管理](docs/part2-system-admin/2.4-systemd-hardening.md)
...
当服务已经稳定运行，可以继续阅读 [systemd 服务沙箱与凭据管理](docs/part2-system-admin/2.4-systemd-hardening.md)，学习如何限制服务可写目录、设备、内核接口和敏感凭据的暴露范围。
