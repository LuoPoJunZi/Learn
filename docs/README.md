...
- [PRACTICE_EXERCISES.md](PRACTICE_EXERCISES.md)：新手练习题与自查答案，覆盖 Python、Linux、Git/GitHub 基础操作
- [TROUBLESHOOTING.md](TROUBLESHOOTING.md)：新手常见问题排查手册，覆盖 Git、Python、Linux、Markdown、Matlab 常见报错
- [STUDY_NOTES_TEMPLATE.md](STUDY_NOTES_TEMPLATE.md)：学习记录模板，用于记录教程学习、脚本运行、报错排查和每周复盘
- [STYLE_GUIDE.md](STYLE_GUIDE.md)：文档整理规范，包含 README、教程、脚本说明、链接和风险提醒的写法建议
