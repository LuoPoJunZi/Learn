...
3. [现代计算案例](<Modern Computing/README.md>)
...
如果你是算法方向，先把 [示例运行指南](RUNNING_EXAMPLES.md) 看完，再运行 [现代计算案例](<Modern Computing/README.md>) 中的两个小脚本。理解矩阵输入、损失和输出后，再进入多目标优化或神经网络目录。
